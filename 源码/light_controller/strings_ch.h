...
"<form action='/wifi'    method='get'><button>配置Wi-Fi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>配置Wi-Fi（无扫描）</button></form><br/>\n", // MENU_WIFINOSCAN
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>WiFi已保存！<br/>设备尝试连接到网络。<br />如果连接失败，请重新尝试连接热点，重新配网！<br />若灯停止闪烁，请到家庭app进行连接！</div>";
